namespace lmv9.Models
{
    ...
    public partial class lmv9Model : DbContext
    {
        public lmv9Model()
            : base("name=simeData")
        {
        ...
        public virtual DbSet<vw_services> vw_services { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<vw_services>()
                .Property(e => e.name)
                .IsUnicode(false);
